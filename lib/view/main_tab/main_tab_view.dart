...
import '../wishlist/wishlist_view.dart'; // Replace with your actual file path
import '../cart/cart_view.dart';       // Replace with your actual file path
...
class _MainTabViewState extends State<MainTabView>
  ...
  List menuArr = [
    ...
    {"name": "Newsletter", "icon": Icons.newspaper}, // Removed the extra space
      ...
      endDrawer: Drawer(
        ...
        child: Container(
          decoration: BoxDecoration(
              color: Colors.grey, // Replace with your actual color
                  ...
                  children: menuArr.map((mObj) {
                    ...
                    return Container(
                      ...
                      decoration: selectMenu == index
                          ? BoxDecoration(color: Color(0xff5ABD8C), boxShadow: [
                              BoxShadow(
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  color: selectMenu == index
                                      ? Colors.white
                                      : Colors.black, // Replace with your actual color
                                  fontSize: 18,
  ...
  SearchView(),
  WishlistScreen(),
  CartScreen(),   // Updated to match the class name in cart_view.dart
]),
      bottomNavigationBar: BottomAppBar(
        color: Color(0xff5ABD8C), // Replace with your actual color
        child: TabBar(
